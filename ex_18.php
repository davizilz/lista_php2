...
$consultas = [
    ['paciente' => 'zilz',   'especialidade' => 'Cardiologia',  'data' => '2026-09-22', 'horario' => '14:00'],
    ['paciente' => 'felipe', 'especialidade' => 'Dermatologia', 'data' => '2026-09-22', 'horario' => '09:00'],
    ['paciente' => 'zilz',   'especialidade' => 'Cardiologia',  'data' => '2026-09-22', 'horario' => '10:30'],
];

print_r(organizarAgenda($consultas));
print_r(pesquisarPaciente($consultas, 'zilz'));